  ...
  const metrics = [
    {
      ...
      value1: `${(district1.graduationRate * 100).toFixed(1)}%`,
      value2: `${(district2.graduationRate * 100).toFixed(1)}%`,
    },
    {
    ...
    {
      label: "Poverty Index",
      value1: `${(district1.povertyIndex * 100).toFixed(1)}%`,
      value2: `${(district2.povertyIndex * 100).toFixed(1)}%`,
    },
  ];
